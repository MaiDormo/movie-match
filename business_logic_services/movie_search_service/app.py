...
from routes.movie_search_routes import router as movie_search_router

app = FastAPI(
    title="Movie Search Service",
    description="A service to provide the results for a movie search",
    version="1.0.0"
)
...
app.include_router(movie_search_router)
